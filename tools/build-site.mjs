...
for (const file of ['index.html','miwale Portfolio.dc.html','support.js','_ds','assets']) cpSync(join(root,file),join(output,file),{recursive:true});
cpSync(join(root,'public'),output,{recursive:true});
console.log('Built responsive portfolio with assets and four games.');
